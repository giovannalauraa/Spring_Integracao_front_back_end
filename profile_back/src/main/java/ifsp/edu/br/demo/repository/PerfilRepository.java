package ifsp.edu.br.demo.repository;
    ...
    public static void init() {
        if (PerfilRepository.repo == null) {
            ...
            PerfilRepository.add(
                    new Perfil(
                            "Erick Brian",
                            "https://lastfm.freetls.fastly.net/i/u/ar0/7946e9940648d5f0ef97e7ed8669ca09.jpg",
                            900000,
                            300,
                            "Havana,Cuba",
                            "luces, cámara, action"));
            ...
            PerfilRepository.add(
                    new Perfil(
                            "Richard Camacho",
                            "https://i.pinimg.com/originals/b6/a1/ca/b6a1ca7b60b2958c95e16f6710c13355.jpg",
                            900000,
                            450,
            ...
            PerfilRepository.add(
                    new Perfil(
                            "Christopher Vélez",
                            "https://img.quizur.com/f/img5e7ac5902530a6.94086711.jpg?lastEdited=1585104277",
                            900000,
                            300,
